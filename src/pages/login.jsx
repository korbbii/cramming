    ...
    <div>
      ...
      <div className="flex justify-center items-center bg-gray-100 font-[sans-serif] text-[#333] h-full md:min-h-screen p-4">
        <div className="mt-40 grid justify-center max-w-md mx-auto">
          <form onSubmit={handleSubmit} className="w-96 bg-white rounded-2xl p-6 md:mb-5 relative z-1 shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)]">
            <div className="mb-5">
            ...
            <div className="mt-10">
              ...
              <p className="text-sm text-center mt-6">Don't have an account? <span onClick={() => { window.location.href = "/pages/register"; }} className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap cursor-pointer">Register here</span></p>
            </div>
