...
import Gameofthrones from './gameofthronesbook.jpg';
import Harrypotter from './harrypotterbook.jpg';
import TrueFiction from './truefictionbook.jpg';
import LordRings from './lordoftheringbook.jpg';
import ThePower from './thepower.jpg';

function Productbooks() {
  ...
  const products = [
    {
      ...
      image: Gameofthrones,
      description: "Enter the epic fantasy world of Westeros in George R. R. Martin's Game of Thrones series.",
      price: '₱389.00',
      rating: 4.5,
    },
    {
    ...
    },
    {
      name: 'Harry Potter',
      image: Harrypotter,
      description: 'Join Harry, Hermione, and Ron in their magical adventures at Hogwarts School of Witchcraft and Wizardry.',
      price: '₱599.00',
      rating: 4.8,
    },
    {
